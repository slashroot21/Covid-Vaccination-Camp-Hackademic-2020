      ...
      <body>
         <div className="hero-bg">
            <section style={{ paddingTop: "40px", paddingBottom: "40px" }}>
               <h1><span> A Remedy</span> To The Pandemic</h1>
               <p style={{ marginTop: "-10px", fontStyle: "italic" }}>It is time to return to our normal lifestyles. Now get the covid19 vaccines at your nearest vaccination center.</p>
               <div className="form-container" style={{ marginTop: "3em" }}>
                  <form action="" >
                     ...
                     <div>
                        <img src={govLogo} alt="Logo of Government of India" />
                     </div>
                  </form>
               </div>
            </section>
